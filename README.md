...
2. 两种翻译选择：百度翻译和通用AI翻译（支持DeepSeek等OpenAI兼容接口）
3. 提示词助手：常用提示词收集整理使用、提示词权重便捷设置、提示词可以使用AI扩写细节
...
3. 安装后设置 百度翻译的参数 或 设置通用AI的Base URL和API Key（默认支持DeepSeek，可配置其他OpenAI兼容服务）
